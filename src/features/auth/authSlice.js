...
//   async (_, { rejectWithValue }) => {
//     try {
//       // ✅ Clear tokens FIRST - this ensures logout even if API fails
//       tokenService.clearTokens();
      
//       // ✅ Try to notify backend (optional, don't wait for it)
//       try {
//         await authApi.logout();
//       } catch (apiError) {
//         // Ignore API errors - we're logging out anyway
//         console.log('Logout API call failed (ignored):', apiError.message);
//       }
